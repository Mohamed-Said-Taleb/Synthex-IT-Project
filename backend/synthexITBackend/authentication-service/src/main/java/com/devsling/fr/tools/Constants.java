...
public class Constants {
    ...
    public static final String  PASSWORD_RESET_NOT_MATCH="Password and confirmation password do not match";
    public static final String  INVALID_PASSWORD_RESET_TOKEN="Invalid or used token";
    public static final String  EXPIRED_PASSWORD_RESET_TOKEN="Invalid or used token";
    ...
    public static final String REGISTRATION_CANDIDATE_MESSAGE = """
            Congratulations! You have successfully registered as a candidate.
    ...
    public static final String REGISTRATION_EMPLOYER_MESSAGE = """
            Congratulations! You have successfully registered as an Employer.
            To activate your account, please check your email inbox and verify your email address.
            Once verified, you will be able to access all features of our platform""";
